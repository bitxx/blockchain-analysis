...
* **关于文章：小编将其copy过来重新编辑了一下，主要是方便按着自己习惯随时翻阅和标注（文中内容会根据自己需要进行一些改动）**
## 感谢 
* 文章基本都是来自[巴比特](http://www.8btc.com/)，还有别的一些渠道，非常感谢，每篇文章小编都会加入对应文章链接，若对作者造成影响，请联系下方微信，小编会及时删除
...
- 其余文章
    - [以太坊ERC20 Token标准完整说明](/doc/article/以太坊ERC20_Token标准完整说明.md)
- go-ethereum源码解析  
    - [常用命令汇总](/doc/command)
